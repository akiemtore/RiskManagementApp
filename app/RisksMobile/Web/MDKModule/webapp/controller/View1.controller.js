sap.ui.define([
	...
	return Controller.extend("RiskManagementApp_RisksMobile.controller.View1", {
        setUrl: function () {
            ...
            var url = sap.ui.require.toUrl("RiskManagementApp_RisksMobile/mdkindex.html?" + queryString);
